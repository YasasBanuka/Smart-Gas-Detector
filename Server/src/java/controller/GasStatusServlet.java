...
//    
//    private volatile String gasLevel = "0";
//    private volatile String gasStatus = "Safe";
//
//    @Override
...
//
//        gasLevel = (level != null) ? level : gasLevel;
//        gasStatus = (status != null) ? status : gasStatus;
//
...
//            throws ServletException, IOException {
//        
//        // Assume gasLevel and gasStatus are obtained from your sensor logic
//        String gasLevel = "50"; // Example value
//        String gasStatus = "Safe"; // Example status
//
//        // Create a JSON object using Gson
//        JsonObject jsonResponse = new JsonObject();
//        jsonResponse.addProperty("level", gasLevel);
//        jsonResponse.addProperty("status", gasStatus);
//
